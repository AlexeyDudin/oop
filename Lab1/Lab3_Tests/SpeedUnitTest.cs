...
namespace Lab3_1_Tests
{
    public class SpeedUnitTest
    {
        ...
        [Test]
        public void Positive_SpeedTest_NeutralGear_SpeedChange()
        {
            var car = new Car();
            car.TurnOnEngine();
            car.SetGear((int)GearSelector.FIRST);
        ...
        [Test]
        public void Negative_SpeedTest_NeutralGear_SpeedChange()
        {
            var car = new Car();
            car.TurnOnEngine();
            car.SetGear((int)GearSelector.FIRST);
        ...
        public void Positive_SpeedTest_SecondGear_SetSpeedIs20()
        {
            ...
            car.SetGear((int)GearSelector.FIRST);
            car.SetSpeed(20);
            car.SetGear((int)GearSelector.SECOND);
            Assert.IsTrue(car.SetSpeed(newSpeed));
        }
        ...
        public void Positive_SpeedTest_ThirdGear_SetSpeedIs30()
        {
            ...
            car.SetGear((int)GearSelector.FIRST);
            car.SetSpeed(30);
            car.SetGear((int)GearSelector.THIRD);
            Assert.IsTrue(car.SetSpeed(newSpeed));
        }
